<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="nom" type="text" class="block w-full" wire:model.defer="state.nom" autocomplete="nom" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="prenom" type="text" class="block w-full" wire:model.defer="state.prenom" autocomplete="prenom" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="dateNaissance" type="date" class="block w-full" wire:model.defer="state.dateNaissance" autocomplete="dateNaissance" />
